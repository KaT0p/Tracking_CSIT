...
<div class="wrapper">
          ...
          <i class="hamburger align-self-center"></i>
            ...
            <main class="content">
				<div class="card-body">
						...
						<div class="card-body">
							<div class="row">
							<div class=" h3 text-center alert alert-success mb-4 mt-4 " role="alert">แก้ไขข้อมูลนิสิต</div>
    <div class="row">
    <form action="update_s.php" method="post">
        ...
        <label>รหัสนิสิต(ใหม่) :</label>
        <input type="text" name="student_id_new" class="form-control"  value = <?=$row['student_id']?> ><br>

        <label>คำนำหน้า :</label> 
        <input class="form-control" name="prefix"  value = <?=$row['prefix']?> > <br>

        <label>ชื่อ :</label>
        <input type="text" name="first_name" class="form-control" value = <?=$row['first_name']?>  ><br>

        <label>นามสกุล :</label>
        <input type="text" name="last_name" class="form-control" value = <?=$row['last_name']?>  ><br>

        <label for="exampleFormControlInput1" class="form-label"  >Email address :</label>
        <input type="email"  name="email" class="form-control" id="exampleFormControlInput1" readonly value = <?=$row['email']?> ><br>

        <label>สาขา :</label> 
        <select class="form-select" name="section"  value = <?=$row['section']?> >
